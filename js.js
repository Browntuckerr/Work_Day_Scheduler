...
$.each(hours, function (index, value) {
    ...
    $(".container").append("<div class='row'><div class='col-2 hour text-right' id='hour" +
        ...
        "<div class='col-2 save-delete' id='save-delete" + (index + 9) + "'><i class='save' title='Save Event'></i> <i class='trash' title='Remove Event'></i></div></div></div>");
});
